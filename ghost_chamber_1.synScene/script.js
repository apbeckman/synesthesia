...
function update(dt) {
  ...
  uniforms.highhits = Math.pow( (inputs.syn_HighLevel*0.5 + inputs.syn_Level*0.125+inputs.syn_HighHits*0.375)*inputs.syn_Intensity, 2.0);
  ...
  uniforms.lowlevel = Math.pow( (inputs.syn_BassLevel*0.45 + inputs.syn_MidLevel*0.375+inputs.syn_Level*0.125)*inputs.syn_Intensity, 2.0);
