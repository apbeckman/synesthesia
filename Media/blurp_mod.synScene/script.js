...
function update(dt) {
  ...
  try {
    ...
    uniforms.smooth_basstime = bpmcount.time*0.75+(bassT*0.25);
    uniforms.smooth_midtime = bpmcount.time*0.75+(midT*0.25);
    uniforms.smooth_hightime = bpmcount.time*0.75+(highT*0.25);
    uniforms.smoothTime = (uniforms.smooth_basstime * 0.65 + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
    uniforms.smoothTimeB = (uniforms.smooth_hightime * 0.65 + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
    uniforms.smoothTimeC = (uniforms.smooth_midtime * 0.65 + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
