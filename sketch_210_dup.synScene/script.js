...
function update(dt) {
  ...
  try {
    ...
    uniforms.smooth_basstime = 0.75*(bpmcount.time * 0.65 + bassT * 0.35);
    uniforms.smooth_midtime = bpmcount.time * 0.85 + midT * 0.35;
    uniforms.smooth_hightime = bpmcount.time * 0.85 + highT * 0.35;
    uniforms.smoothTime = 0.75*
      (uniforms.smooth_basstime * 0.5 +
      inputs.TIME * 0.125 +
      inputs.syn_Time * 0.05);
