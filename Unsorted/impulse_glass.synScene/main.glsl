...
#define TIMEINPERIOD    (mod(TIME, PERIODTIME))
#define PERIOD          (mod(floor(TIME / PERIODTIME), 9.0))
//#define PERIOD          8
...
vec4 renderMainImage() {
  ...
  if (TIME > PERIODTIME*9.0) whiteOut = 1.0;
