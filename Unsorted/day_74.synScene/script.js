...
function update(dt) {
  ...
  try {
    bassTimevar.updateTime(0.35, Math.pow((0.5+inputs.syn_BassLevel+inputs.syn_MidLevel*0.75+syn_Intensity*0.25), 2.0)*(inputs.rate_in), dt);
    ...
    uniforms.highhits = Math.pow( (inputs.syn_HighLevel*0.5 + + syn_MidHighLevel*0.25 + inputs.syn_Hits*0.125+inputs.syn_HighHits*0.125)*inputs.syn_Intensity, 2.0);
