...
function update(dt) {
  ...
  try {
    ...
    uniforms.smooth_basstime = bpmcount.time*0.65+(bassT*0.35);
    uniforms.smooth_midtime = bpmcount.time*0.65+(midT*0.35);
    uniforms.smooth_hightime = bpmcount.time*0.65+(highT*0.35);
    uniforms.smoothTime = (uniforms.smooth_basstime  + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
    uniforms.smoothTimeB = (uniforms.smooth_hightime  + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
    uniforms.smoothTimeC = (uniforms.smooth_midtime  + inputs.TIME * 0.125 + inputs.syn_Time * 0.2);
