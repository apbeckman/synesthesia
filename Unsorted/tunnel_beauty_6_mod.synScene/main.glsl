...
vec4 renderMainImage() {
	...
	float perturbedAmt = pow(syn_Presence*0.25+syn_Intensity*0.75,1.5);
  ...
  fragColor.rgb += tex3D(syn_UserImage, p*0.01+0.5, n)*(syn_Presence*0.5+syn_Intensity*0.5)*0.9*_pulse(fract(-syn_BPMSin4+p.z*0.01), 0.5, media_width);
