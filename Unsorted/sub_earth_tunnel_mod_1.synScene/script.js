...
function update(dt) {
  ...
  try {
    bassTimevar.updateTime(0.25, Math.pow((inputs.rate_in/Math.abs(rate_in)+inputs.syn_BassLevel*1.5+inputs.syn_MidLevel*0.5+syn_Intensity*0.25), 2.0)*(inputs.rate_in), dt);
