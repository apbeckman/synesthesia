...
var xTimevar = new Timer();
var yTimevar = new Timer();
...
function update(dt) {
  ...
  try {
    ...
    xTimevar.updateTime(
      0.65,
      Math.pow(
        inputs.syn_BassLevel * 1.2 +
          inputs.syn_MidHighLevel * 0.3 +
          inputs.syn_MidLevel * 1.5 +
          inputs.syn_Intensity * 0.5,
        2.0
      ) * inputs.morph_1.x,
    ...
    uniforms.ytime = yTimevar.time;
    uniforms.xtime = xTimevar.time;
