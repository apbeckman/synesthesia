...
float minRadius2 = 0.9+MinRadius;
float fixedRadius2 = 5.7+FxRadius ;
float foldingLimit = 1.3+FoldingLimit;

int Iterations = 6;
float Scale = 1.9+FractalScale;
