...
function update(dt) {
  ...
  try {
    bassTimevar.updateTime(0.3, Math.pow((0.5+inputs.syn_BassLevel+inputs.syn_MidLevel*0.75+syn_Intensity*0.25), 2.0)*(inputs.rate_in), dt);
    ...
    spinTimevar.updateTime(.05,  Math.pow(0.5+inputs.syn_BassLevel*0.75+inputs.syn_MidLevel*0.75+syn_Intensity,2.0)*(inputs.xTravel), dt);
