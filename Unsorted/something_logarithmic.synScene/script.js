...
function update(dt) {
  ...
  try {
    ...
    midTimevar.updateTime(0.25, Math.pow((inputs.syn_BassLevel*0.5+inputs.syn_MidHighLevel+inputs.syn_MidLevel*1.5+inputs.syn_Intensity*0.5), 2.0)*(inputs.ball_time), dt);
