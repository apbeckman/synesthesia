...
function update(dt) {
  ...
  try {
    bassTimevar.updateTime(0.4, Math.pow((0.5+inputs.syn_BassLevel+inputs.syn_MidLevel*0.725+syn_Intensity*0.25), 2.0)*(inputs.rate_in), dt);

    midTimevar.updateTime(0.125, Math.pow((inputs.syn_BassLevel*0.785+inputs.syn_MidHighLevel*0.9+inputs.syn_MidLevel*1.5+inputs.syn_Intensity*0.5), 2.0)*(inputs.RotZ), dt);
    ...
    uniforms.low = Math.pow( (inputs.syn_Bass1Level*0.5 + inputs.syn_MidLevel*0.375+inputs.syn_Level*0.125)*inputs.syn_Intensity, 2.0);
