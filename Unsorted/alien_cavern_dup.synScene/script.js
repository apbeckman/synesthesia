...
function update(dt) {
  ...
  bassTimevar.updateTime(10.75, Math.pow((Math.max(0.5, inputs.syn_BassLevel*1.)+inputs.syn_MidLevel*0.75+0.25*syn_Intensity), 2.0)*(-1.0*(inputs.rate_in)), dt);
  uniforms.bt = bassTimevar;
