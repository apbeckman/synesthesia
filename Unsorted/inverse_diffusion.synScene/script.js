...
function update(dt) {
  uniforms.growthFactor = Math.pow((inputs.syn_BassLevel*0.4)+(inputs.syn_MidLevel*0.35)+(inputs.syn_Intensity*0.25), 2.0);
  ...
  uniforms.basshits = Math.pow(inputs.syn_BassLevel*0.25 + (inputs.syn_Level*0.25+inputs.syn_BassHits*0.35), 2.0)*inputs.syn_Intensity;
