...
function update(dt) {
  ...
  try {
    ...
    spinTimevar.updateTime(.1,  Math.pow(0.5+inputs.syn_BassLevel*0.75+inputs.syn_MidLevel*0.75+syn_Intensity,2.0)*(inputs.col_speed), dt);
    ...
    uniforms.col_time = spinTimevar.time;
    ...
    uniforms.low = Math.pow( (inputs.syn_BassLevel*0.525 + inputs.syn_MidLevel*0.475)*(1.0 + inputs.syn_Intensity*0.25), 2.0);
