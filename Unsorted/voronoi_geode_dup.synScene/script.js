...
function update(dt) {
  ...
  try {
    bassTimevar.updateTime(0.2, Math.pow((0.5+inputs.syn_BassLevel+inputs.syn_MidLevel*0.75+syn_Intensity*0.25), 2.0)*(inputs.speed_motion), dt);
    ...
    timevar.updateTime(0.5, inputs.speed_motion, dt);
