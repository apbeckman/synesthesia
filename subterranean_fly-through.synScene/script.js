...
function update(dt) {
  ...
  var morph_speed = inputs.Path_Reactivity;
  try {
    ...
    morphTimeVar.updateTime(1.0,
    (inputs.syn_Level*2.0 + inputs.syn_Presence + inputs.syn_Hits*1.0 + inputs.syn_BassHits*4.0)*morph_speed, dt);

    bassTimeVar.updateTime(0.5, inputs.Hue_Time > 0.5 ? inputs.syn_Level*1.0 + inputs.syn_BassLevel*2.0 : 0, dt);
