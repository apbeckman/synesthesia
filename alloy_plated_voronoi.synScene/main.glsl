...
/*
	...
	situation really messes with your sense of correctness, uncomment the "RIGID_SCROLL" 
...
float tetraNoise(in vec3 p){
    ...
    return clamp(dot(d, v*v*v*8.)*1.2732 + .5, 0., 1.); // Not sure if clamping is necessary. Might be overkill.
