...
function update(dt) {
  ...
  bassT = bassT + (inputs.syn_BassLevel*0.35)+(inputs.syn_MidLevel*0.25)+(inputs.syn_Level * 0.15);
  uniforms.script_bass_time = bassT;
  highT = highT + (inputs.syn_HighLevel*0.35)+(inputs.syn_MidHighLevel*0.25)+(inputs.syn_Level * 0.15);
