...
function update(dt) {
    var fly_speed = inputs.rotation_speed;
    var rate_in = inputs.rate_in;
    var morph_rate = inputs.growth_bounce_rate;    var react = 0;
    ...
    flyTimeVar.updateTime(1., inputs.reactive_time ?
    (inputs.syn_Level*2.0 + inputs.syn_Presence + inputs.syn_Hits*1.0 + inputs.syn_BassHits*2.0)*fly_speed : fly_speed, dt);
    morphTimeVar.updateTime(0.1, (inputs.syn_BassLevel*2.0+inputs.syn_BassPresence+inputs.syn_BassHits*2.0)*morph_rate, dt);
    hueTimeVar.updateTime(0.3, (inputs.syn_BassLevel*2.0+inputs.syn_BassPresence+inputs.syn_BassHits*4.0)*inputs.hue_rate, dt);
